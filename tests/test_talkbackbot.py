...
QUOTE = "Nobody minds having what is to good for them. ~ Jane Austen"
...
class TestTalkBackBot(unittest.SynchronousTestCase):
    ...
    def test_privmsgNoTrigger(self):
        """Shouldnt send a quote if message does not match trigger"""
    ...
    def test_privmsgPrivateMessage(self):
        """For private messages, should send qoute directly to user"""
